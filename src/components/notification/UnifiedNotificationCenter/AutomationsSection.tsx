...
export const AutomationsSection: React.FC<AutomationsSectionProps> = ({ onRefresh }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-black text-gray-900">Notification Automations</h2>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-purple-400 transition-colors"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-purple-400 transition-colors resize-none"
                      />
                    </div>
                      ...
                      <div className="space-y-3 bg-gray-50 p-4 rounded-xl">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 rounded-lg border border-gray-200 outline-none focus:border-purple-400 transition-colors"
                          />
                        </div>
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full px-3 py-2 rounded-lg border border-gray-200 outline-none focus:border-purple-400 transition-colors resize-none"
                          />
                        </div>
                      </div>
                    )}
