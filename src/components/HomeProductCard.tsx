...
export const HomeProductCard: React.FC<HomeProductCardProps> = ({ product, onClick, isPopular, isInWishlist = false, onAddToWishlist }) => {
  ...
  // Check if product is in cart - only for non-sized products
  // For sized products, we treat them as "not in cart" here to force opening the modal
  // because we can't easily increment/decrement specific sizes from the card
